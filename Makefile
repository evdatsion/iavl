...
HTTPS_GIT := https://github.com/evdatsion/iavl.git

PDFFLAGS := -pdf --nodefraction=0.1
CMDFLAGS := -ldflags -X TENDERMINT_IAVL_COLORS_ON=on 
LDFLAGS := -ldflags "-X github.com/evdatsion/iavl.Version=$(VERSION) -X github.com/evdatsion/iavl.Commit=$(COMMIT) -X github.com/evdatsion/iavl.Branch=$(BRANCH)"
